...
`
## Download
⚠️Please, if you can, share this repository further so that the project can thrive - it's very important to me!⚠️ <a name="download-section"></a>
...
You can download the `all in one` zip file from [Google Drive](https://drive.google.com/file/d/1UDXXlpSiRary1y7c3_VpbP5nqR6iPbEi/view?usp=sharing).
